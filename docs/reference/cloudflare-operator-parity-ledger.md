...
- Operations currently eligible to count as complete: **40**
- Routes currently eligible to count as complete: **15**
...
| Activity, API, event, and webhook logs | missing | 16 | 6 | Redacted tenant-scoped event and request projections with bounded retention | Developer log routes were omitted rather than ported. |
