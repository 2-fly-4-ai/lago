...
| Payment request           | payment-request API and later dunning owner                                                   | request, version-pinned overdue invoice links, and outbox                                                                 | tenant/customer/currency checks; invoice version/status trigger; one D1 batch                                                        |
