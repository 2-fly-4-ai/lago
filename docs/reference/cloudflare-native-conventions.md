...
| Usage event               | metered-usage API                                                    | event row and outbox; R2 archive is content-addressed                                     | tenant transaction ID uniqueness; canonical request hash; duplicate-body replay and conflict tests        |
