/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 23fdd6b919a8835ab74f61999ff0d23e)
...
interface __BaseEnv_Env {
	...
	EASY_PAY_DIRECT_ORGANIZATION_ID: "org-synthetic-e2e-20260815-001";
	EASY_PAY_DIRECT_SUCCESS_REDIRECT_URL: "https://serp-dev-safe-store.serpcompany.workers.dev/checkout/success";
	...
	EASY_PAY_DIRECT_ONE_TIME_TAX_CODE: "txcd_10202000";
	EASY_PAY_DIRECT_TAX_MAX_DATA_AGE_DAYS: "45";
	INDIRECT_TAX_ADDRESS_ENCRYPTION_KEY_ID: "v1";
	PROVIDER_READS_ENABLED: "1";
	STRIPE_NETWORK_MODE: "enabled";
	STRIPE_WEBHOOKS_ENABLED: "1";
	STRIPE_LIVEMODE_ALLOWED: "0";
	STRIPE_ACCOUNT_CODE: "acct_1Rba2Z06JrOmKRCm";
	STRIPE_ORGANIZATION_ID: "org-synthetic-e2e-20260815-001";
	OUTBOUND_WEBHOOKS_ENABLED: "1";
	BILLING_ACCOUNTS: DurableObjectNamespace<import("./src/index").BillingAccount>;
	CHECKOUT_WORKFLOW: Workflow<Parameters<import("./src/index").CheckoutWorkflow['run']>[0]['payload']>;
	RECONCILIATION_WORKFLOW: Workflow<Parameters<import("./src/index").ReconciliationWorkflow['run']>[0]['payload']>;
	DOCUMENT_WORKFLOW: Workflow<Parameters<import("./src/index").DocumentWorkflow['run']>[0]['payload']>;
	PLAN_DELETION_WORKFLOW: Workflow<Parameters<import("./src/index").PlanDeletionWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "BillingAccount";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "PUBLIC_BASE_URL" | "PAYMENT_MUTATIONS_ENABLED" | "EASY_PAY_DIRECT_AUTOMATIC_COLLECTION_ENABLED" | "EASY_PAY_DIRECT_AUTOMATIC_COLLECTION_SCOPE_MODE" | "EASY_PAY_DIRECT_NETWORK_MODE" | "EASY_PAY_DIRECT_LIVEMODE_ALLOWED" | "EASY_PAY_DIRECT_ACCOUNT_CODE" | "EASY_PAY_DIRECT_ORGANIZATION_ID" | "EASY_PAY_DIRECT_SUCCESS_REDIRECT_URL" | "CREDIT_NOTE_REFUND_MODE" | "WALLET_FUNDING_MODE" | "EXTERNAL_TAX_MODE" | "EASY_PAY_DIRECT_TAX_MODE" | "EASY_PAY_DIRECT_TAX_PROVIDER" | "EASY_PAY_DIRECT_TAX_CODE" | "EASY_PAY_DIRECT_ONE_TIME_TAX_CODE" | "EASY_PAY_DIRECT_TAX_MAX_DATA_AGE_DAYS" | "INDIRECT_TAX_ADDRESS_ENCRYPTION_KEY_ID" | "PROVIDER_READS_ENABLED" | "STRIPE_NETWORK_MODE" | "STRIPE_WEBHOOKS_ENABLED" | "STRIPE_LIVEMODE_ALLOWED" | "STRIPE_ACCOUNT_CODE" | "STRIPE_ORGANIZATION_ID" | "OUTBOUND_WEBHOOKS_ENABLED">> {}
}
