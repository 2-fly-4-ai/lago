...
interface __BaseEnv_Env {
  ...
  CHECKOUT_WORKFLOW: Workflow<
    Parameters<import("./src/index").CheckoutWorkflow["run"]>[0]["payload"]
  >;
  RECONCILIATION_WORKFLOW: Workflow<
    Parameters<import("./src/index").ReconciliationWorkflow["run"]>[0]["payload"]
  >;
  DOCUMENT_WORKFLOW: Workflow<
    Parameters<import("./src/index").DocumentWorkflow["run"]>[0]["payload"]
  >;
  PLAN_DELETION_WORKFLOW: Workflow<
    Parameters<import("./src/index").PlanDeletionWorkflow["run"]>[0]["payload"]
  >;
}
...
declare namespace NodeJS {
  interface ProcessEnv extends StringifyValues<
    Pick<
      ...
      | "EASY_PAY_DIRECT_TAX_MAX_DATA_AGE_DAYS"
      | "PROVIDER_READS_ENABLED"
      | "STRIPE_NETWORK_MODE"
      | "STRIPE_WEBHOOKS_ENABLED"
      | "STRIPE_LIVEMODE_ALLOWED"
      | "STRIPE_ACCOUNT_CODE"
      | "STRIPE_ORGANIZATION_ID"
      | "OUTBOUND_WEBHOOKS_ENABLED"
    >
  > {}
}
