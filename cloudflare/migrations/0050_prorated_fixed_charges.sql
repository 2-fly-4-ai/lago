-- In-arrears fixed charges may use Lago's local-day unit proration. Pay-in-advance remains
-- separately guarded because it requires invoice-at-event and rebilling workflows.
