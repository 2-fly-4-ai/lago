-- Enable automatic EPD collection only for the recurring Store products reviewed
-- in the 2026-09-11 full-catalog staging rollout. One-time products are omitted.
...
INSERT OR REPLACE INTO easy_pay_direct_product_collection_policies
...
WHERE organization.id IN ('org-synthetic-e2e-20260815-001', 'org-epd-serptest-20260909');
