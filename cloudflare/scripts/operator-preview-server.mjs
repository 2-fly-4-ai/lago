...
const primaryPreviewCollections = {
  ...
  payment_disputes: [
    {
      lago_id: "dispute-preview-001",
      provider: "stripe",
      provider_account_code: "stripe-preview",
      provider_dispute_id: "dp_preview_001",
      payment_id: "payment-preview-stripe-001",
      invoice_id: "invoice-preview-001",
      invoice_number: "SERP-2026-001",
      amount_cents: 1200,
      currency: "USD",
      reason: "product_not_received",
      status: "needs_response",
      evidence_due_by: "2026-08-27T00:00:00Z",
      livemode: false,
      provider_created_at: "2026-08-18T02:00:00Z",
...
function previewApi(pathname, requestedSlug, method = "GET", searchParams = new URLSearchParams()) {
  ...
  const collections = {
    ...
    "/api/operator/v1/payment-disputes": "payment_disputes",
    "/api/operator/v1/provider-refunds": "provider_refunds",
